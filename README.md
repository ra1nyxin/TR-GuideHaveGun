...
怪贴近向导时，会优先原地举枪反击，而不是继续后撤拉开。 | When enemies get close, the Guide now favors standing his ground and returning fire instead of continuing to back away.
...
近距离接敌时压低后撤倾向。 | Reduces retreat behavior during close-range engagements.
